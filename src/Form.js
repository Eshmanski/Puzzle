class Form {
  ...
  init(rootEl) {
    ...
    this.mediator.addMethod('renameShowBtn', (isShow) => this.renameShowBtn(isShow));
  ...
  renameShowBtn(isShow) {
    if(isShow) {
      this.showBtn.textContent = 'Убрать плитки';
    } else {
      this.showBtn.textContent = 'Показать плитки';
    }
  }
